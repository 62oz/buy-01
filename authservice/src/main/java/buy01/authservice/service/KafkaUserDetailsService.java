...
public class KafkaUserDetailsService implements UserDetailsService {
    ...
    private final KafkaTemplate<String, ClientAuthenticationRequest> kafkaTemplate;
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        kafkaTemplate.send("user-details-request-topic", new ClientAuthenticationRequest(requestId, username));
